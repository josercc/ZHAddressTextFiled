#
#  Be sure to run `pod spec lint ZHAddressTextFiled.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/josercc/ZHAddressTextFiled.git", :tag => "#{s.version}" }
  ...
  s.source_files  = "ZHAddressTextFiled-Objective-C/ZHAddressTextFiled/*"
